...
Page({
    ...
    type:function(){  //贷款类型
        ...
        wx.showActionSheet({
            ...
            success:function(res){
                ...
                //算法
                money=(parseFloat(clt.sta.money(bm,br,lm))+parseFloat(clt.sta.money(am,ar,lm))).toFixed(2);
                insterest=(parseFloat(clt.sta.rat(bm,br,lm))+parseFloat(clt.sta.rat(am,ar,lm))).toFixed(2);
                all=(parseFloat(clt.sta.all(bm,br,lm))+parseFloat(clt.sta.all(am,ar,lm))).toFixed(2);
                pr=(parseFloat(clt.sta.poor(bm,br,lm))+parseFloat(clt.sta.poor(am,ar,lm))).toFixed(2);
                self.setData({
                    bm:bm,
                    money:money,
                    insterest:insterest,
    ...
    bmont:function(res){  //输入框
        ...
        var lm=this.data.limit;
        //算法
        money=(parseFloat(clt.sta.money(pm,br,lm))+parseFloat(clt.sta.money(am,ar,lm))).toFixed(2);
        insterest=(parseFloat(clt.sta.rat(pm,br,lm))+parseFloat(clt.sta.rat(am,ar,lm))).toFixed(2);
        all=(parseFloat(clt.sta.all(pm,br,lm))+parseFloat(clt.sta.all(am,ar,lm))).toFixed(2);
        pr=(parseFloat(clt.sta.poor(pm,br,lm))+parseFloat(clt.sta.poor(am,ar,lm))).toFixed(2);
        if(!parseInt(pm)){
            money=0.00;
            insterest=0.00;
            all=0.00;
    ...
    amont:function(res){
        ...
        var lm=this.data.limit;
        //算法
        money=(parseFloat(clt.sta.money(pm,ar,lm))+parseFloat(clt.sta.money(bm,br,lm))).toFixed(2);
        insterest=(parseFloat(clt.sta.rat(pm,ar,lm))+parseFloat(clt.sta.rat(bm,br,lm))).toFixed(2);
        all=(parseFloat(clt.sta.all(pm,ar,lm))+parseFloat(clt.sta.all(bm,br,lm))).toFixed(2);
        pr=(parseFloat(clt.sta.poor(pm,ar,lm))+parseFloat(clt.sta.poor(bm,br,lm))).toFixed(2);console.log(money,insterest,all,pr)
        if(!parseInt(pm)){
            money=0.00;
            insterest=0.00;
            all=0.00;
